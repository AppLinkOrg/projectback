...
$sql="select distinct member_id,nickName,avatarUrl,helpup.help_id from tb_helpup helpup
inner join tb_member member on helpup.member_id=member.id 
where helpup.help_id=$help_id";
