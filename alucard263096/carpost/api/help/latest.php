...
$sql="select id,photo,published_date,title,description from tb_help help";
if($new!="1970-01-01 08:00:00"){
$sql.=" where published_date>'$new' order by published_date desc";
}elseif($latest!="1970-01-01 08:00:00"){
$sql.=" where published_date<'$latest' order by  published_date desc limit 0,3";
}else{
