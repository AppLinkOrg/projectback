...
////以下是代码开始，请勿删除此行注释
////starthere
$filed=$_REQUEST["field"];
   if($filed=="playinback"){
       $playinback=$_REQUEST["playinback"]=="Y"?"Y":"N";
       $dbmgr->query("update tb_member set playinback='$playinback' where id=$member_id ");
       outputJson(outResult(0,"SUCCESS",$playinback));
   }
