...
////以下是代码开始，请勿删除此行注释
////starthere
$name=parameter_filter($_REQUEST["name"]);$photo=parameter_filter($_REQUEST["photo"]);$introduce=parameter_filter($_REQUEST["introduce"]);$sql="update tb_member set nickName='$name',avatarUrl='$photo',introduce='$introduce' where id=$member_id";$dbmgr->query($sql);outputJson(outResult(0,"Success"));
